...
class frontpage_hook_Lang extends _HOOK_CLASS_
{
	/**
	 * Set words
	 *
	...
	public function languageInit()
	{
		...
		foreach( \IPS\frontpage\Databases::getDatabaseDataFromStore() as $database )
		{
			...
			$fieldsClass = '\IPS\frontpage\Fields' . $database['database_id'];
