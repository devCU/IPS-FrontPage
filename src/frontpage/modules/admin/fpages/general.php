...
class _general extends \IPS\Dispatcher\Controller
{
	...
	protected function manage()
	{
		...
		$view = $this->_manageGeneral();

		\IPS\Output::i()->title = \IPS\Member::loggedIn()->language()->addToStack('head_frontpage_general');
	...
	protected function _manageGeneral()
	{
		...
		/* Display */
		return \IPS\Theme::i()->getTemplate( 'fpages', 'frontpage', 'admin' )->general();
	}
