 ...
 *
 * @brief       FrontPage UpdateRecords Task
...
/**
 * FrontPage UpdateRecords Task
 */
class _FrontpageUpdateRecords extends \IPS\Task
{
	/**
	 * Execute
	 *
	...
	public function execute()
	{
		foreach( \IPS\frontpage\Databases::databases() as $database )
		{
			...
			/* Check the database is placed on a valid fpage */
			try
			{
